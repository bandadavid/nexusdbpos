...
namespace Ada369Csharp.Presentacion.LICENCIAS_MENBRESIAS
{
    public partial class Licencias : UserControl
    {
        ...
        {
            Process.Start("https://mundodelimpiezatanicuchi.com/");
        }
        ...
        {
            dlg.Filter = "Licencias NexusDBPOS|*.xml";
            dlg.Title = "Cargador de Licencias NexusDBPOS";
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                if (NombreSoftwareLicencia == "NexusDBPOS")
                {
